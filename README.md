...
| [大語言模型應用與實戰](https://andy6804tw.github.io/crazyai-llm/)|  探討 LLM 的基礎概念、調校技巧與實務應用，透過實作範例，帶你輕鬆上手並打造專屬 AI 應用。   | 1%       | [加入討論](https://github.com/andy6804tw/crazyai-llm/issues) |
